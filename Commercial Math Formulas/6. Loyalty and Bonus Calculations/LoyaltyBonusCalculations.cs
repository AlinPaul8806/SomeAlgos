...
namespace CommercialMathFormulas.LoyaltyBonusCalculations
{
    public class LoyaltyBonusCalculations
    {
        ...
        public int CalculatePointsEarned(decimal purchaseAmount)
        {
        ...
        public decimal RedeemPoints(int points, decimal pointsToDollarRate = 0.01m)
        {
        ...
        public decimal CalculateBonus(decimal baseAmount, decimal bonusPercent)
        {
