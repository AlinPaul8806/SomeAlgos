...
namespace CommercialMathFormulas.FraudDetectionFormulas
{
    public class FraudDetectionFormulas
    {
        ...
        public static bool ExceedsVelocity(int orderCount, int timeWindowMinutes, int maxOrdersPerWindow)
        {
        ...
        public static decimal AddressMismatchScore(string billingCountry, string shippingCountry, string ipCountry)
        {
            decimal score = 0;
        ...
        public static bool UnusuallyHighAmount(decimal orderAmount, decimal historicalAvg, decimal stdDev, decimal zScoreThreshold = 3)
        {
