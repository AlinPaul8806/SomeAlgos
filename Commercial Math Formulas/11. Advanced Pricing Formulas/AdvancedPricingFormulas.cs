...
namespace CommercialMathFormulas.AdvancedPricingFormulas
{
    public class AdvancedPricingFormulas
    {
        ...
        public static decimal VolumeDiscount(decimal basePrice, int quantity, (int minQty, decimal discountPercent)[] tiers)
        {
        ...
        public static decimal BundlePrice(decimal[] individualPrices, decimal bundleDiscountPercent)
        {
        ...
        public static decimal SkimmingPrice(decimal initialPrice, decimal reductionRatePerDay, int days)
        {
